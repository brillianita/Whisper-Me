...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* <div className="bg-blue/[0.3] p-5 mx-auto mt-10"> */}
      <div className="relative w-full h-[600px] overflow-hidden-lg mt-10 p-4">
        ...
        <div className="absolute mx-auto w-full pt-5">
          ...
          {/* <h2 className="text-4xl font-bold text-center text-black mt-5 h-16 w-auto">Choose Your WhisperMe! Experience</h2> */}
